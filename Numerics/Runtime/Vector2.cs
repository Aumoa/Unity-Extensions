...
namespace Ayla.Numerics
{
    ...
    public struct Vector2 : IVector2, IEquatable<Vector2>
    {
        ...
        public static Vector2 identity
        {
            ...
            get => Vector2Utility.Make<Vector2>(0, 0);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Vector2 rhs) => Vector2Utility.NearlyEquals(this, rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 operator -(in Vector2 lhs) => Vector2Utility.Inverse(lhs);
