...
namespace Ayla.Inspector
{
    public class NativePropertyDrawer
    {
        ...
        {
            using var changedScope = Scopes.ChangedScope();
            ...
            else
            {
                ...
                else
                {
                    switch (typeCode)
                    {
                        ...
                        case TypeCode.Boolean:
                            boolValue = EditorGUI.Toggle(position, label, conv.ToBoolean(null));
                            handled = true;
                            break;
                ...
                if (GUI.changed && handled && property.isEditable)
                {
                    ...
                    else
                    {
                        switch (typeCode)
                        {
                            ...
                            case TypeCode.Decimal:
                                ...
                                break;
                            case TypeCode.Boolean:
                                property.SetValue(boolValue.Value);
                                break;
                            case TypeCode.String:
